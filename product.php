...
<head>
    ...
    <title>MSI Laptop Price in Bangladesh 2025 | A2Z Dorkary</title>
    <base href="https://www.a2zdorkary.com" />
    <meta name="description" content="Buy MSI Laptop at the best price in Bangladesh. Latest MSI Laptop available at A2Z Shop. Order online to get delivery anywhere in BD." />    <meta name="keywords" content= "MSI Laptop Price in BD" />    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <link rel="icon" type="image/png" href="a2zdorkary-logo.png">    <link href="https://www.a2zdorkary.com/laptop-notebook/laptop/msi-laptop.html" rel="canonical" /><link href="D:/www.a2zdorkary.com/laptop-notebook/laptop/msi-laptop.html?page=1" rel="prev" /><link href="https://www.a2zdorkary.com/laptop-notebook/laptop/msi-laptop-page-3.html?page=3" rel="next" />          <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://www.a2zdorkary.com/category.min.16.css" type="text/css" rel="stylesheet" media="screen" />        <script type="text/javascript">var app={mgs_type: "popup", enablePopup: 1, popupDuration: 6, onReady:function(d,a,e,f,t){a=Array.isArray(a)?a:[a];t=t||2E3;for(var g=!0,b=d,c=0;c<a.length;c++){var h=a[c];if("undefined"==typeof b[h]){g=!1;break}b=b[h]}g?e():f&&setTimeout(function(){app.onReady(d,a,e,--f)},t)}};</script>
        ...
        <ul class="navbar-nav">
                ...
                <ul class="drop-down drop-menu-1">
                        ...
                        <div class="drop-down drop-menu-2">
                                                        <ul>
                                                                <li>
                                    <a href="https://www.startech.com.bd/a4tech-earbuds">A4Tech</a>
                                </li>
                                                                <li>
...
<section class="after-header p-tb-10">
    <div class="container c-intro">
        <ul class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li  itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemtype="http://schema.org/Thing" itemprop="item" href="https://www.startech.com.bd/laptop-notebook/laptop/msi-laptop"><span itemprop="name">MSI</span></a><meta itemprop="position" content="3" /></li>
                    </ul><h1>MSI Laptop Price in Bangladesh</h1>

<p>MSI Laptop Price in Bangladesh starts from BDT 56,500 to BDT 135,000 depending on the series, models, and features. Buy latest MSI Laptop at lowest price from Star Tech online shop. Browse below and order yours now!</p>        <div class="child-list">
                    </div>
    </div>
</section>
<section class="p-item-page bg-bt-gray p-tb-15">
<div class="container"><div class="row"><column id="column-left" class="col-sm-3">
  ...
  <div class="price-filter ws-box">
    ...
    <div class="pf-wrap">
    <div id="rang-slider" class="noUi-horizontal" data-from="0" data-to="989900" data-min="0" data-max="989900"></div>
    </div>
  ...
  <div class="items">
      ...
      <span>Consumer Laptops</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="2369" />
      <span>Business Laptops</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2370" />
      <span>Gaming Laptops</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2371" />
      <span>Premium Ultrabook Laptops</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="413">
  <div class="label">
    <span>Processor Type</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="3010" />
      <span>Intel</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3011" />
      <span>AMD</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3090" />
      <span>Snapdragon</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="414">
  <div class="label">
    <span>Processor Model</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="3012" />
      <span>Intel CDC</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3013" />
      <span>Intel PQC</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3014" />
      <span>Intel Core i3</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3015" />
      <span>Intel Core i5</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3016" />
      <span>Intel Core i7</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3017" />
      <span>Intel Core i9</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3058" />
      <span>Intel Core Ultra 5</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3018" />
      <span>Intel Core Ultra 7</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3019" />
      <span>Intel Core Ultra 9</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3020" />
      <span>AMD Athlon</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3021" />
      <span>AMD Ryzen 3</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3022" />
      <span>AMD Ryzen 5</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3023" />
      <span>AMD Ryzen 7</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3024" />
      <span>AMD Ryzen 9</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3087" />
      <span>Snapdragon X Elite</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3088" />
      <span>Snapdragon X Plus</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3295" />
      <span>Intel Core 3</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3296" />
      <span>Intel Core 5</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3297" />
      <span>Intel Core 7</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3603" />
      <span>Snapdragon X X1</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3678" />
      <span>Ryzen AI 9</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3679" />
      <span>Ryzen AI 7</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3680" />
      <span>Ryzen AI 5</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="5">
  <div class="label">
    <span>Generation/Series</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="1052" />
      <span>Intel 10th Gen</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1164" />
      <span>Intel 11th Gen</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1903" />
      <span>Intel 12th Gen</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2225" />
      <span>Intel 13th Gen</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2790" />
      <span>Intel 14th Gen</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1900" />
      <span>Ryzen 3000 Series</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1901" />
      <span>Ryzen 4000 Series</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1902" />
      <span>Ryzen 5000 Series</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1997" />
      <span>Ryzen 6000 Series</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2578" />
      <span>Ryzen 7000 Series</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2812" />
      <span>Ryzen 8000 Series</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3681" />
      <span>Ryzen AI 300 Series</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="3">
  <div class="label">
    <span>Display Size</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="2069" />
      ...
      <span>15-Inch to 15.9-Inch</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="1071" />
...
<div class="filter-group ws-box show" data-group-id="288">
  <div class="label">
    <span>Display Type</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="1886" />
      <span>LED</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1887" />
      <span>OLED</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1888" />
      <span>AMOLED</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="6">
  <div class="label">
    <span>RAM Size</span>
  </div>
  <div class="items">
      ...
      <span>8 GB</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="3571" />
      <span>12 GB</span>
    </label>
        <label class="filter">
      ...
      <span>16 GB</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="2754" />
      <span>18 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3202" />
      <span>24 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1053" />
      <span>32 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2755" />
      <span>36 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2756" />
      <span>48 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2171" />
      <span>64 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3721" />
      <span>96 GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2797" />
      <span>128 GB</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="364">
  <div class="label">
    <span>RAM Type</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="2644" />
      <span>DDR4</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2645" />
      <span>DDR5</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="7">
  <div class="label">
    <span>HDD</span>
  </div>
  <div class="items">
...
<div class="filter-group ws-box show" data-group-id="15">
  <div class="label">
    <span>SSD</span>
  </div>
  <div class="items">
      ...
      <span>1 TB</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="1074" />
      <span>2 TB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2417" />
      <span>4 TB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3722" />
      <span>6 TB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2798" />
      <span>8 TB</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="20">
  <div class="label">
    <span>Graphics</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="1904" />
      ...
      <span>Dedicated 10GB</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="2579" />
      <span>Dedicated 12GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1905" />
      <span>Dedicated 16GB</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3558" />
      <span>Dedicated 24GB</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="289">
  <div class="label">
    <span>Operating System</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="1889" />
      <span>Free Dos</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1890" />
      <span>Windows</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1891" />
      <span>macOS</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2680" />
      <span>ChromeOS</span>
    </label>
      </div>
</div>
<div class="filter-group ws-box show" data-group-id="51">
  <div class="label">
    <span>Special Features</span>
  </div>
  <div class="items">
        <label class="filter">
      <input type="checkbox" name="filter" value="270" />
      <span>Backlit Keyboard</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="271" />
      ...
      <span>360°</span>
        ...
        <label class="filter">
      <input type="checkbox" name="filter" value="1880" />
      <span>Touch Screen</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="1881" />
      <span>Dual Display</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="2107" />
      <span>Type-C Port</span>
    </label>
        <label class="filter">
      <input type="checkbox" name="filter" value="3421" />
      <span>RJ45 LAN Port</span>
    </label>
      </div>
</div>
</div>  </column>
        <div id="content" class="col-xs-12 col-md-9 product-listing">
          ...
          <div class="row">
              <div class="col-sm-4 col-xs-2 actions">
                  ...
                  <label class="page-heading m-hide">MSI</label>
              </div>
      ...
      <div class="main-content p-items-wrap">
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">1,500৳ Discount on Checkout</span>                                        </div>
                                    <div class="p-item-img"><a href="D:/www.a2zdorkary.com/msi-modern-15-f13mg-core-i3-13th-gen-fhd-laptop.html"><img src="D:/www.a2zdorkary.com/Laptop-Product-Image/msi-modern-15-f13mg-core-i3-13th-gen-fhd-laptop/modern-15-f13mg-003-228x228.webp" alt="MSI Modern 15 F13MG Core i3 13th Gen 15.6&quot; FHD Laptop Platinum Gray" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="D:/www.a2zdorkary.com/msi-modern-15-f13mg-core-i3-13th-gen-fhd-laptop.html">MSI Modern 15 F13MG Core i3 13th Gen 15.6&quot; FHD Laptop Platinum Gray</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i3-1315U (10M Cache, 3.3 GHz, up to 4.50 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 15.6&quot; FHD (1920x1080) 
</li><li>Features: Backlit Keyboard, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>56,500৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39201', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39201');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">1,500৳ Discount on Checkout</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-f13mg-core-i3-13th-gen-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg-urban-silver/modern-15-f13mg-urban-silver-001-228x228.webp" alt="MSI Modern 15 F13MG Core i3 13th Gen 15.6&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-f13mg-core-i3-13th-gen-laptop">MSI Modern 15 F13MG Core i3 13th Gen 15.6&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i3-1315U (10M Cache, 3.3 GHz, up to 4.50 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 15.6&quot; FHD (1920x1080) 
                          ...
                          <span>56,500৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39202', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39202');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i3-13-gen-14-inch-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg-urban-silver/modern-15-f13mg-urban-silver-001-228x228.webp" alt="MSI Modern 14 F13MG Core i3 13th Gen 14&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i3-13-gen-14-inch-laptop">MSI Modern 14 F13MG Core i3 13th Gen 14&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i3-1315U (10M Cache, up to 4.50 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 14&quot; IPS Level FHD (1920x1080), 60Hz, 45% NTSC
</li><li>Features: Backlit Keyboard With Copilot Key, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>56,500৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('40933', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('40933');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i3-13-gen-laptop-platinum-gray"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg/modern-15-f13mg-003-228x228.webp" alt="MSI Modern 14 F13MG Core i3 13th Gen 14&quot; FHD Laptop Platinum Gray" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i3-13-gen-laptop-platinum-gray">MSI Modern 14 F13MG Core i3 13th Gen 14&quot; FHD Laptop Platinum Gray</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i3-1315U (10M Cache, up to 4.50 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 14&quot; IPS Level FHD (1920x1080), 60Hz, 45% NTSC
                          ...
                          <span>56,500৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('40935', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('40935');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 2,000৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-c7m-ryzen-5-7430u-14-inch-fhd-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-14-c7m/modern-14-c7m-01-228x228.webp" alt="MSI Modern 14 C7M AMD Ryzen 5 7430U 14&quot; FHD Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-c7m-ryzen-5-7430u-14-inch-fhd-laptop">MSI Modern 14 C7M AMD Ryzen 5 7430U 14&quot; FHD Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 5 7430U (2.3GHz up to 4.3GHz, 16MB Cache)
</li><li>RAM: 16GB DDR4 3200MHz, Storage: 512GB SSD
</li><li>Display: 14&quot; FHD (1920 x 1080) IPS Level
</li><li>Features: Backlit Keyboard, Type-C, WiFi 6E</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">66,000৳</span> <span class="price-old">68,000৳</span>
                                                </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39630', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39630');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 2,000৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-b7m-ryzen-5-7430u-fhd-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-14-c7m/modern-14-c7m-01-228x228.webp" alt="MSI Modern 15 B7M AMD Ryzen 5 7430U 15.6&quot; FHD Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-b7m-ryzen-5-7430u-fhd-laptop">MSI Modern 15 B7M AMD Ryzen 5 7430U 15.6&quot; FHD Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 5 7430U (2.3GHz up to 4.3GHz, 16MB Cache)
</li><li>RAM: 16GB DDR4 3200MHz, Storage: 512GB SSD
</li><li>Display: 15.6&quot; FHD (1920 x 1080) IPS Level
</li><li>Features: Backlit Keyboard, Type-C, WiFi 6E</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">66,000৳</span> <span class="price-old">68,000৳</span>
                                            ...
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39635', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39635');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i5-laptop-urban-silver"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg-urban-silver/modern-15-f13mg-urban-silver-001-228x228.webp" alt="MSI Modern 14 F13MG Core i5 13th Gen 14&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i5-laptop-urban-silver">MSI Modern 14 F13MG Core i5 13th Gen 14&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i5 1334U (12M Cache, up to 4.60 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 14&quot; IPS Level FHD (1920x1080), 60Hz, 45% NTSC
</li><li>Features: Backlit Keyboard With Copilot Key, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>69,500৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('42250', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('42250');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">1,000৳ Discount on Checkout</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-f13mg-core-i5-laptop-urban-silver"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg-urban-silver/modern-15-f13mg-urban-silver-001-228x228.webp" alt="MSI Modern 15 F13MG Core i5 13th Gen 15.6&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-f13mg-core-i5-laptop-urban-silver">MSI Modern 15 F13MG Core i5 13th Gen 15.6&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i5-1335U (12M Cache, up to 4.60 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 15.6&quot; FHD (1920x1080) 
</li><li>Features: Backlit Keyboard, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>72,000৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39341', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39341');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 5,500৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-b7m-ryzen-7-7730u-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-a5m/modern-15-b7m-classic-black-07-228x228.webp" alt="MSI Modern 15 B7M Ryzen 7 7730U 15.6&quot; FHD Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-b7m-ryzen-7-7730u-laptop">MSI Modern 15 B7M Ryzen 7 7730U 15.6&quot; FHD Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 7 7730U (8-core/16-thread, 16MB cache, up to 4.5 GHz)
</li><li>RAM: 8GB DDR4 3200Mhz, Storage: 512GB NVMe SSD
</li><li>Display: 15.6&quot; FHD (1920x1080) 
</li><li>Features: Backlit Keyboard, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">72,000৳</span> <span class="price-old">77,500৳</span>
                                                </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('36001', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('36001');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-f1mg-core-5-120u-laptop-urban-silver"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f1mg/modern-15-f1mg-urban-silver-01-228x228.webp" alt="MSI Modern 15 F1MG Core 5 120U AI Optimized 15.6&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-f1mg-core-5-120u-laptop-urban-silver">MSI Modern 15 F1MG Core 5 120U AI Optimized 15.6&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core 5 120U (12M Cache, Up to 5.4 GHz)
</li><li>RAM: 8GB DDR4, Storage: 512GB NVMe PCIe Gen4x4 SSD
</li><li>Display: 15.6&quot; FHD (1920x1080) IPS, 60Hz, 45%NTSC
</li><li>Features: Backlit Keyboard, Webcam Shutter, Type-C, Wi-Fi 6E</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>78,900৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39611', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39611');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 1,500৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-c7m-ryzen-7-7730u-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-14-c7m/modern-14-c7m-01-228x228.webp" alt="MSI Modern 14 C7M Ryzen 7 7730U 14&quot; Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-c7m-ryzen-7-7730u-laptop">MSI Modern 14 C7M Ryzen 7 7730U 14&quot; Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 7 7730U (8-core/16-thread, 16MB cache, up to 4.5 GHz)
</li><li>RAM: 16GB DDR4 3200Mhz, Storage: 512GB NVMe SSD
</li><li>Display: 14&quot; FHD (1920x1080)
</li><li>Features: Backlit Keyboard, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">77,500৳</span> <span class="price-old">79,000৳</span>
                                                </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39615', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39615');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 1,500৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-b7m-ryzen-7-7730u-16gb-laptop-classic-black"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-b7m/modern-15-b7m-classic-black-07-228x228.webp" alt="MSI Modern 15 B7M Ryzen 7 7730U 16GB RAM 15.6&quot; FHD Laptop Classic Black" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-b7m-ryzen-7-7730u-16gb-laptop-classic-black">MSI Modern 15 B7M Ryzen 7 7730U 16GB RAM 15.6&quot; FHD Laptop Classic Black</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 7 7730U (8C/16T, 16MB cache, up to 4.5 GHz)
</li><li>RAM: 16GB DDR4 3200Mhz, Storage: 512GB NVMe SSD
</li><li>Display: 15.6&quot; FHD (1920x1080)  IPS Level Display
</li><li>Features: Backlit Keyboard, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">77,500৳</span> <span class="price-old">79,000৳</span>
                                            ...
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('42645', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('42645');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">2,000৳ Discount on Checkout</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-f1mg-core-5-120u-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f1mg/modern-15-f1mg-platinum-gray-01-228x228.webp" alt="MSI Modern 15 F1MG Core 5 120U AI Optimized 15.6&quot; FHD Laptop Platinum Gray" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-f1mg-core-5-120u-laptop">MSI Modern 15 F1MG Core 5 120U AI Optimized 15.6&quot; FHD Laptop Platinum Gray</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core 5 120U (12M Cache, Up to 5.4 GHz)
</li><li>RAM: 8GB DDR4, Storage: 512GB NVMe PCIe Gen4x4 SSD
</li><li>Display: 15.6&quot; FHD (1920x1080) IPS, 60Hz, 45%NTSC
                                            ...
                                            <div class="p-item-price">
                          <span>79,500৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39609', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39609');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">1,000৳ Discount on Checkout</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i7-13-gen-14-inch-laptop-platinum-gray"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg/modern-15-f13mg-003-228x228.webp" alt="MSI Modern 14 F13MG Core i7 13th Gen 14&quot; FHD Laptop Platinum Gray" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i7-13-gen-14-inch-laptop-platinum-gray">MSI Modern 14 F13MG Core i7 13th Gen 14&quot; FHD Laptop Platinum Gray</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i7-1355U (12M Cache, up to 5.00 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 14&quot; IPS Level FHD (1920x1080), 60Hz, 45% NTSC
</li><li>Features: Backlit Keyboard With Copilot Key, Type-C</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>87,900৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39577', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39577');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">1,000৳ Discount on Checkout</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i7-13-gen-14-inch-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f13mg-urban-silver/modern-15-f13mg-urban-silver-001-228x228.webp" alt="MSI Modern 14 F13MG Core i7 13th Gen 14&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i7-13-gen-14-inch-laptop">MSI Modern 14 F13MG Core i7 13th Gen 14&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i7-1355U (12M Cache, up to 5.00 GHz)
</li><li>RAM: 8GB DDR4 3200MHz RAM, Storage: 512GB Gen4 SSD 
</li><li>Display: 14&quot; IPS Level FHD (1920x1080), 60Hz, 45% NTSC
                          ...
                          <span>87,900৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('40931', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('40931');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-thin-15-b13uc-core-i5-13th-gen-rtx-3050-fhd-gaming-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/thin-15-b13ve/thin-15-b13vethin-15-b13ve-01-228x228.webp" alt="MSI Thin 15 B13UC Core i5 13th Gen RTX 3050 4GB Graphics 15.6&quot; FHD Gaming Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-thin-15-b13uc-core-i5-13th-gen-rtx-3050-fhd-gaming-laptop">MSI Thin 15 B13UC Core i5 13th Gen RTX 3050 4GB Graphics 15.6&quot; FHD Gaming Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i5-13420H (12M Cache, 3.4 GHz up to 4.6 GHz)
</li><li>RAM: 8GB DDR4, Storage: 512B SSD
</li><li>Graphics: GeForce RTX 3050 4GB GDDR6
</li><li>Features: Single Backlit Keyboard, Type-C, Wi-Fi 6E, 144Hz Refresh Rate</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>89,900৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39200', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39200');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-modern-15-f1mg-core-7-150u-laptop-urban-silver"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/modern-15-f1mg/modern-15-f1mg-urban-silver-01-228x228.webp" alt="MSI Modern 15 F1MG Core 7 150U AI Optimized 15.6&quot; FHD Laptop Urban Silver" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-modern-15-f1mg-core-7-150u-laptop-urban-silver">MSI Modern 15 F1MG Core 7 150U AI Optimized 15.6&quot; FHD Laptop Urban Silver</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core 7 150U (12M Cache, Up to 5.4 GHz)
</li><li>RAM: 8GB DDR4, Storage: 1TB NVMe PCIe Gen4x4 SSD
</li><li>Display: 15.6&quot; FHD (1920x1080) IPS, 60Hz, 45%NTSC
</li><li>Features: Backlit Keyboard, Webcam Shutter, Type-C, Wi-Fi 6E</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>100,900৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39612', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39612');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
                    <div class="p-item">
              <div class="p-item-inner">
                                   <div class="p-item-img"><a href="https://www.startech.com.bd/msi-thin-15-b13ve-i5-13th-gen-gaming-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/thin-15-b13ve/thin-15-b13vethin-15-b13ve-01-228x228.webp" alt="MSI Thin 15 B13VE Core i5 13th Gen RTX 4050 6GB Graphics 15.6&quot; FHD Gaming Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-thin-15-b13ve-i5-13th-gen-gaming-laptop">MSI Thin 15 B13VE Core i5 13th Gen RTX 4050 6GB Graphics 15.6&quot; FHD Gaming Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: Intel Core i5-13420H (12M Cache, 3.4 GHz up to 4.6 GHz)
</li><li>RAM: 8GB DDR4, Storage: 512GB SSD
</li><li>Graphics: GeForce RTX 4050 6GB GDDR6
</li><li>Features: Single Backlit Keyboard, Type-C, Wi-Fi 6E, 144Hz Refresh Rate</li></ul>
                      </div>
                                            <div class="p-item-price">
                          <span>102,900৳</span>                      </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('36325', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('36325');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 10,000৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-thin-a15-b7uc-ryzen-5-7535hs-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/thin-15-b13ve/thin-15-b13vethin-15-b13ve-01-228x228.webp" alt="MSI Thin A15 B7UC Ryzen 5 7535HS RTX 3050 4GB GDDR6 Graphics 15.6&quot; FHD Gaming Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-thin-a15-b7uc-ryzen-5-7535hs-laptop">MSI Thin A15 B7UC Ryzen 5 7535HS RTX 3050 4GB GDDR6 Graphics 15.6&quot; FHD Gaming Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 5 7535HS (3.3GHz up to 4.55GHz, 6 cores)
</li><li>RAM: 16GB (2x 8GB) DDR5, Storage: 512GB SSD
</li><li>Graphics: NVIDIA GeForce RTX 3050 4GB GDDR6 Graphics
</li><li>Features: Backlit Keyboard, Dual Speakers, Wi-Fi 6E</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">95,000৳</span> <span class="price-old">105,000৳</span>
                                                </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('39614', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('39614');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="p-item-inner">
                                   <div class="marks">
                      <span class="mark">Save: 5,000৳</span>                                        </div>
                                    <div class="p-item-img"><a href="https://www.startech.com.bd/msi-thin-a15-b7ve-ryzen-7-7735hs-laptop"><img src="https://www.startech.com.bd/image/cache/catalog/laptop/msi/thin-a15-b7ve/thin-a15-b7ve-1-228x228.webp" alt="MSI Thin A15 B7VE Ryzen 7 7735HS RTX 4050 6GB GDDR6 Graphics 15.6&quot; FHD Gaming Laptop" width="228" height="228"></a></div>
                  <div class="p-item-details">
                      <h4 class="p-item-name"> <a href="https://www.startech.com.bd/msi-thin-a15-b7ve-ryzen-7-7735hs-laptop">MSI Thin A15 B7VE Ryzen 7 7735HS RTX 4050 6GB GDDR6 Graphics 15.6&quot; FHD Gaming Laptop</a></h4>
                      <div class="short-description">
                          <ul><li>Processor: AMD Ryzen 7 7735HS (3.2GHz up to 4.75GHz, 8 cores)
</li><li>RAM: 16GB (2x 8GB) DDR5, Storage: 512GB SSD
</li><li>Graphics: NVIDIA GeForce RTX 4050 6GB GDDR6 Graphics
</li><li>Features: Backlit Keyboard, Dual Speakers, Wi-Fi 6E</li></ul>
                      </div>
                                            <div class="p-item-price">
                                                    <span class="price-new">135,000৳</span> <span class="price-old">140,000৳</span>
                                                </div>
                                            <div class="actions">
                                                    <span class="st-btn btn-add-cart" type="button" onclick="cart.add('42642', '1');"><i class="material-icons">shopping_cart</i> Buy Now</span>
                                                    <span class="st-btn btn-compare" onclick="compare.add('42642');"><i class="material-icons">library_add</i>Add to Compare</span>
                      </div>
                  </div>
              </div>
          </div>
      ...
      <div class="bottom-bar">
          <div class="row">
              <div class="col-md-6 col-sm-12">
                  <ul class="pagination"><li><span class="disabled">PREV</span></li><li class="active"><span>1</span></li><li><a href="https://www.startech.com.bd/laptop-notebook/laptop/msi-laptop?page=2">2</a></li><li><a href="https://www.startech.com.bd/laptop-notebook/laptop/msi-laptop?page=3">3</a></li><li><a href="https://www.startech.com.bd/laptop-notebook/laptop/msi-laptop?page=4">4</a></li><li><a href="https://www.startech.com.bd/laptop-notebook/laptop/msi-laptop?page=2">NEXT</a></li></ul>              </div>
              <div class="col-md-6 rs-none text-right">
                  <p>Showing 1 to 20 of 68 (4 Pages)</p>
              </div>
          </div>
      </div>
      <div class="category-description p-15 ws-box">
          <p><br></p><h2>Latest MSI Laptop Price List in BD</h2>
          <table class="latest-product-list table-bordered">
              <tr><th class="txt-left">MSI Laptop List</th><th class="text-right">Price in BD</th></tr>
              <tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-modern-15-f13mg-core-i3-16gb-ram-laptop-urban-silver">MSI Modern 15 F13MG Core i3 13th Gen 16GB RAM 15.6&quot; FHD Laptop Urban Silver</a></td><td class="product-price text-right">55,500৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-modern-15-f13mg-core-i3-16gb-laptop-platinum-gray">MSI Modern 15 F13MG Core i3 13th Gen 16GB RAM 15.6&quot; FHD Laptop Platinum Gray</a></td><td class="product-price text-right">55,500৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i3-16gb-laptop-urban-silver">MSI Modern 14 F13MG Core i3 13th Gen 16GB RAM 14&quot; FHD Laptop Urban Silver</a></td><td class="product-price text-right">55,500৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-modern-14-f13mg-core-i3-16gb-laptop">MSI Modern 14 F13MG Core i3 13th Gen 16GB RAM 14&quot; FHD Laptop Platinum Gray</a></td><td class="product-price text-right">55,500৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-vector-16-hx-ai-a2xwhg-gaming-laptop">MSI Vector 16 HX AI A2XWHG Core Ultra 9 275HX RTX 5070 TI 12GB Graphics 16&quot; QHD+ 240Hz Gaming Laptop</a></td><td class="product-price text-right">349,900৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-vector-16-hx-ai-a2xwig-gaming-laptop">MSI Vector 16 HX AI A2XWIG Core Ultra 9 275HX RTX 5080 16GB Graphics 16&quot; QHD+ 240Hz Gaming Laptop</a></td><td class="product-price text-right">449,900৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-raider-18-hx-ai-a2xwig-gaming-laptop">MSI Raider 18 HX AI A2XWIG Core Ultra 9 200HX RTX 5080 16GB Graphics 18&quot; UHD+ MiniLED 120Hz Gaming Laptop</a></td><td class="product-price text-right">629,800৳</td></tr><tr class="latest-product"><td class="product-name"><a href="https://www.startech.com.bd/msi-venturepro-15-a2rweg-laptop">MSI VenturePro 15 A2RWEG Core 5 210H RTX 5050 8GB Graphics 15.6&quot; FHD Gaming Laptop</a></td><td class="product-price text-right">144,900৳</td></tr>          </table>
          <h1>Get the Top All Rounding MSI Laptops within the best Price Range in Bangladesh<br></h1><p>Micro-Star International Co Ltd more commonly referred to as MSI is a Multinational Taiwanese Information Technology Corporation. The headquarters of MSI is located in New Taipei City. MSI makes almost all types of computing-related components starting from motherboards to monitors, to laptops. MSI does everything by itself from designing to developing and finally selling. MSI is renowned for its PC components and the build quality of its product. In almost all the PC components, MSI’s product is available as they compete with the toughest and best component-making companies.<br></p><h3>MSI Laptops Incorporated with the Latest Graphics Cards and Processors for Optimum Performance<br></h3><p>MSI laptops are one of the topmost discussed products and are also referred to as one of the best performing laptops. You will be able to find both average working laptops and also high-performing gaming laptops from MSI. MSI especially focuses on their gaming components as MSI has gaming in their DNA. MSI provides its laptop with high-performing Processors that are able to complete complicated tasks. Also, MSI has provided their laptops with strong and top-performing Dedicated Graphics Cards gives you all the power to do anything from gaming to content creating. These MSI laptops can be called “The Beasts” as they are more than capable of through any tasks and completely devour them.<br></p><h3>Get the Beast for Yourself<br></h3><p>You will be able to get all the top MSI Laptops from Star Tech. You can visit us on our website and buy the Laptop that you want from there. If you are in the Dhaka City area, you can enjoy our Home Delivery service and if you are outside of the Dhaka city area, we will be able to courier your desired laptop to your desired area. You can also visit our authorized outlets which are located in Dhaka, Gazipur, Chattagram, Khulna, Gazipur, and Rangpur, and see the product first hand.<br></p>      </div>
 </div>
 </div></div>
...
// সব প্রোডাক্ট আনা
$sql = "SELECT id, name, main_image, price FROM products WHERE status='active'";
$result = $conn->query($sql);

while($row = $result->fetch_assoc()){
    echo '<div class="product">';
    echo '<img src="images/'.$row['main_image'].'" alt="'.$row['name'].'" width="200">';
    echo '<h3>'.$row['name'].'</h3>';
    ...
    <div class="container">
        <div class="main-footer">
            ...
            <div class="footer-block contact-us">
                <h4>Support</h4>
                    <a href="tel:09639151489" class="helpline-btn footer-big-btn">
                    <div class="ic"><i class="material-icons">phone</i></div>
                    <p>9 AM - 8 PM </p>
                    <h5>09639151489</h5>
                </a>

                <a href="http://information/contact" class="store-locator-btn footer-big-btn">
            ...
            <div class="footer-block about-us">
                <h4>About Us</h4>
                <ul>
                                        <li><a href="http://www/affiliate-program">Affiliate Program</a></li>
                                        <li><a href="http://emi-terms">EMI Terms</a></li>
                                        <li><a href="http://about_us">About Us</a></li>
                                        <li><a href="http://online-delivery">Online Delivery</a></li>
                                        <li><a href="http://privacy">Privacy Policy</a></li>
                                        <li><a href="http://warranty-policy">Terms and Conditions</a></li>
                                        <li><a href="http://refund-policy">Refund and Return Policy</a></li>
                                        <li><a href="http://star-point-policy">Star Point Policy</a></li>
                                        <li><a href="http://career">Career</a></li>
                                        <li><a href="http://blog">Blog</a></li>
                    <li><a href="http://information/contact">Contact Us</a></li>
                    <li><a href="http://product/manufacturer">Brands</a></li>
                </ul>
            </div>
            <div class="footer-block org-info">
                <h4>Stay Connected</h4>
                <p><b class="store-name">A2Z Dorkary Ltd</b><br/>Head office : Puraton Thana Para, Kurigram - 5600</p>
                <p><b>Email:</b><br/><a href="mailto:a2zdorkary@gmail.com">a2zdorkary@gmail.com</a> </p>
            </div>
        </div>

        <div class="social-footer">
            <div class="app-links">
                <span class="app-link-text">Experience A2Z Dorkary App on your mobile:</span>
                <span class="app-link-items">
                    <a class="app-link" href="https://play.google.com" target="_blank" rel="noopener" title="A2Z Dorkary Android APP">
                    ...
                    <a class="app-link" href="https://apps.apple.com" target="_blank" rel="noopener" title="A2Z Dorkary ISO APP">
            ...
            <div class="social-links">
                <a href="https://wa.me/8801761111875" target="_blank" rel="noopener" title="Whatsapp">
                ...
                <a href="https://www.youtube.com/@badisco/featured" target="_blank" rel="noopener" title="Youtube">
        ...
        <div class="row sub-footer">
            <div class="col-md-6 copyright-info">
                <p>© 2025 A2Z Dorkary | All rights reserved</p>
            </div>
            <div class="col-md-6 powered-by">
                <p>Powered By: A2Z Dorkary</p>
            </div>
        </div>
    </div>
</footer>
